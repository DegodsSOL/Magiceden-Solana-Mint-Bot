...
You can support me with some SOL : 2oGn8HnMLJdJNofdG5X2EM9n43gtrRPKVZC1LLGyC81p
...
1. Clone the repository / Download zip file
    ...
    `git clone https://github.com/DegodsSOL/Magiceden-Solana-Mint-Bot.git`

    OR

    [Download Zip File](https://github.com/DegodsSOL/Magiceden-Solana-Mint-Bot/archive/refs/heads/main.zip)
...
4. Replace Phantom Passphrase in `config.json`
